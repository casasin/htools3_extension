...
class BooleanOperationsDialog(GlyphsDialogBase):
    ...
    title = 'boolean'
    key = '%s.boolean' % GlyphsDialogBase.key
    settings = {}
    ...
    def backgroundPreview(self, notification):
        ...
        # get preview
        g1 = g.getLayer(self.glyph1Layer)
        g2 = g.getLayer(self.glyph2Layer)
        previewGlyph = g.getRepresentation("%s.preview" % self.key, glyph1=g1, glyph2=g2, operation=self.boolOperation) # clear=self.clearGlyph
    ...
    def apply(self):
        ...
        for glyphName in glyphNames:
            ...
            result = g.getRepresentation("%s.preview" % self.key, glyph1=g1, glyph2=g2, operation=self.boolOperation)
